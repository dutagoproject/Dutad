...
For the active release line, use the `1.0.2` packaging and install guides in this repo.
...
For current operator guidance, use the current `1.0.2` release and deployment documents in this repository.
