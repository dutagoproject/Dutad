...
./tools/build_release_bundle.sh 1.0.2-v4.1-rc1
```

The bundle will be created in:

```text
dist/duta-release-1.0.2-v4.1-rc1-linux-x86_64
```

A compressed archive will also be created:

```text
dist/duta-release-1.0.2-v4.1-rc1-linux-x86_64.tar.gz
```
...
./tools/build_release_bundle.sh 1.0.2-v4.1-rc1 x86_64-unknown-linux-musl
```
...
```bash
./dist/duta-release-1.0.2-v4.1-rc1-linux-x86_64/dutad --help
./dist/duta-release-1.0.2-v4.1-rc1-linux-x86_64/duta-cli --help
./dist/duta-release-1.0.2-v4.1-rc1-linux-x86_64/dutaminer --help
```
