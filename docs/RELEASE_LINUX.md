...
```text
dist/duta-release-0.0.1-beta-linux-x86_64
```

A compressed archive will also be created:

```text
dist/duta-release-0.0.1-beta-linux-x86_64.tar.gz
```
...
./tools/build_release_bundle.sh 0.0.1-beta x86_64-unknown-linux-musl
```
...
```bash
./dist/duta-release-0.0.1-beta-linux-x86_64/dutad --help
./dist/duta-release-0.0.1-beta-linux-x86_64/duta-cli --help
./dist/duta-release-0.0.1-beta-linux-x86_64/dutaminer --help
```
